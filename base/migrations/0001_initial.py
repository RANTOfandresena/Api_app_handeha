    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('idTrajet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.trajet')),
            ],
        ),
        migrations.CreateModel(
            name='Paiement',
            fields=[
                ...
                ('idReservation', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='base.reservation')),
            ],
        ),
        migrations.AddField(
            model_name='trajet',
            name='idVehicule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='base.vehicule'),
        ),
    ]
